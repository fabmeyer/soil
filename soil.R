...
# third: model 12 (CEC2 ~ OC2), fourth: model 5 (CEC1 ~ OC2)
...
#### 8. put all 18 p-values into a list and comprare them ####
...
# interpretation: For a linear model, the null model is defined
# as the dependent variable being equal to its mean.
# So, the p-value for the model is answering the question,
# Does this model explain the data significantly better
# than would just looking at the average value of the dependent variable?
